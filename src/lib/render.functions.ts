...
async function generateCopy(input: {
  ...
  const sys = [
    ...
    "",
    "SCROLL-STOP RULE (beat 1 and 2 decide everything):",
    "• The FIRST beat must stop the scroll inside 0.6s. Use one of: a number/timeframe ('4 hours a week'), a blunt admission ('nobody told me this'), a mid-action fragment ('so I stopped posting'), a flipped belief ('more content isn't the problem'), or a direct callout of the viewer's situation.",
    "• NEVER open with a topic label, a greeting, a brand name, 'in today's world', 'let's talk about', or a question that can be answered 'no'.",
    "• Beat 1 must be readable in one glance: max 4 words.",
    "",
    "CURIOSITY GAP RULE (this is what keeps them watching):",
    "• Open a loop early and close it LATE. State the outcome or the shift before you explain it, so the viewer has to stay for the 'why'.",
    "• Withhold exactly one thing — the mechanism, the number, or the turn — until the last 2 beats. Do not resolve it in the middle.",
    "• Put a small pattern-interrupt around beat 4–6: a one-word beat, a contradiction, or a 'but' turn. No mid-reel flat stretch.",
    "• The final beat must land, not trail off — a realisation, a reframe, or a line the viewer would repeat. Never end on a connective word.",
    "",
